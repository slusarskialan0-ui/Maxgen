...
### Pipeline (`/pipeline`) — wymagany payload dla uruchomienia
...
```json
{
  "message": "Pipeline uruchomiony dla województwa: mazowieckie",
  "voivodeship": "mazowieckie"
}
```

Uwaga: `POST /pipeline/run` bez body JSON zwróci `422 Unprocessable Entity`.

  ...
  return (
    <div className="p-8">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
        ...
        <StatCard label="Leady / konwersja" value={`${stats.total_leads || 0} / ${stats.conversion_rate_pct || 0}%`} color="yellow" />
        <StatCard label="Przychód (płatności)" value={`${Math.round(stats.revenue_total || 0)} PLN`} color="purple" />
      </div>

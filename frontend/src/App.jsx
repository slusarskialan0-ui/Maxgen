...
import AutoControlCenter from './pages/AutoControlCenter'
...
import OffersPanel from './pages/OffersPanel'
...
const NAV = [
  ...
  { to: '/kampanie', label: '📣 Kampanie' },
  { to: '/automatyzacje', label: '⚡ Automatyzacje' },
  { to: '/sprzedaz', label: '💼 Panel sprzedaży' },
  { to: '/oferty', label: '🧾 Panel ofert' },
  { to: '/uzytkownicy', label: '👤 Użytkownicy' },
  { to: '/sync', label: '🔄 Sync & Backup' },
  { to: '/social', label: '🔗 Social Bridge' },
  ...
  { to: '/auto-control', label: '🤖 AUTO-CONTROL' },
  ...
  { to: '/setup', label: '⚙️ Kreator Setup' },
]
      ...
      <div className="flex-1 flex flex-col md:ml-64 min-h-screen">
        ...
        <main className="flex-1 overflow-auto">
          <Routes>
            ...
            <Route path="/kampanie" element={<Campaigns />} />
            <Route path="/automatyzacje" element={<AutomationsPage />} />
            <Route path="/sprzedaz" element={<SalesPanel />} />
            <Route path="/oferty" element={<OffersPanel />} />
            <Route path="/uzytkownicy" element={<UsersConfig />} />
            ...
            <Route path="/auto-control" element={<AutoControlCenter />} />

...
const NAV = [
  ...
  { to: '/ruch', label: '📈 Dashboard ruchu' },
  { to: '/przychody', label: '💸 Dashboard przychodów' },
      ...
      <div className="flex-1 flex flex-col md:ml-64 min-h-screen">
        ...
        <main className="flex-1 overflow-auto">
          <Routes>
            ...
            <Route path="/ruch" element={<TrafficDashboard />} />
            <Route path="/przychody" element={<RevenueDashboard />} />

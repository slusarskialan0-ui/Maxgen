...
from app.automation_defaults import ensure_default_automation_rules
...
def init_db():
    ...
    try:
        ...
        # Seed/repair default automations for lead workflow
...
_effective_cors_origins = CORS_ORIGINS or ["http://localhost:3000", "http://127.0.0.1:3000"]
_allow_credentials = "*" not in _effective_cors_origins

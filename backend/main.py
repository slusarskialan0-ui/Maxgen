...
from app.background_engine import start_background_engine, stop_background_engine, get_background_engine_status
...
async def lifespan(application):
    init_db()
    await start_background_engine()
    try:
        yield
    finally:
        await stop_background_engine()
...
@app.get("/auto/engine-status", tags=["system"])
def auto_engine_status():
    return get_background_engine_status()
